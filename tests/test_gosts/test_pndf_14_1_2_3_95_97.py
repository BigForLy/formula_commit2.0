...
class TestPNDF14_1_2_3_95_97:
    ...
    def test_PNDF14_1_2_3_95_97(self):
        data = [
            NumericField(symbol="@ctr", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="1",
                         primary_key="1"),
            NumericField(symbol="@vtr", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="1",
                         primary_key="2"),
            NumericField(symbol="@v", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="1",
                         primary_key="3"),
            NumericField(symbol="@qq", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="1",
                         primary_key="4"),
            ...
            NumericField(symbol="@exp", round_to=-3, is_round_with_zeros=False, definition_number="1",
                         formula="if(@qq='Используется',1.25*40.08*1000*(@ctr*@vtr)/@v,if(@qq='Не используется',40.08*1000*(@ctr*@vtr)/@v,null*null))",
                         value=1,
                         primary_key="7"),

            NumericField(symbol="@ctr", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="2",
                         primary_key="8"),
            NumericField(symbol="@vtr", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="2",
                         primary_key="9"),
            NumericField(symbol="@v", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="2",
                         primary_key="10"),
            NumericField(symbol="@qq", round_to=-3, value="", formula="", is_round_with_zeros=False, definition_number="2",
                         primary_key="11"),
            ...
            NumericField(symbol="@exp", round_to=-3, is_round_with_zeros=False, definition_number="2",
